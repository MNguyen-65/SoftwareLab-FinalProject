...
export default function ProjectsPage() {
 ...
 const handleJoinProject = async () => {
    ...
    return (
        <div className="text-center m-5-auto" style={{textAlign:'center', color:'green'}}>
            <button onClick={handleLogout} id="sub_btn1" style={{ backgroundColor: 'crimson', color: '#ffffff', fontSize: '24px', padding: '5px 10px' }}> Log off</button>
            <h1>Welcome!</h1>
            <p>User ID: {userId}</p>
            ...
            {/* <form action="/projenter"> */}
                <p>
                    ...
                    <br />
                    <button onClick={handleCreateProject} style={{ backgroundColor: 'crimson', color: '#ffffff', fontSize: '24px', padding: '5px 10px' }} >Create Project</button>
                </p>
                <p>
                    <h2>Join Project</h2>
                    <input type="text" placeholder="Project ID" value={existingProjectId} onChange={e => setExistingProjectId(e.target.value)} />
                    <br />
                    <button onClick={handleJoinProject} style={{ backgroundColor: 'crimson', color: '#ffffff', fontSize: '24px', padding: '5px 10px' }}>Join Project</button>
                </p>
            <h2>Your Projects</h2>
            <div>
                    <Project />
